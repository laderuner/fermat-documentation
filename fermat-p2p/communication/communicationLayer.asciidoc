[[Fermat-P2P-Communication-Layer]]
= Communication Layer
...
There is an identification system that identify devices, actors and <<Fermat-DMP-Network-Service-Layer,network services>> that consist in pairs of keys generating by asymmetric cryptography methods. +
